...
export function SettingsPanel() {
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      <main className="entropy-titlebar-end min-h-0 flex-1 overflow-auto" aria-label="Settings">
        <div className="mx-auto w-full max-w-md px-6 py-10">
            ...
            <div className="flex items-center justify-between gap-6 py-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  Ink on soft surfaces by default. Dark uses #131413 chrome.
                </p>
              </div>
              <Switch
                id="theme-switch"
                ...
                {DENSITY_OPTIONS.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={cn(
                        "rounded-lg border px-2.5 py-2.5 text-left transition-colors duration-150",
                        active
                          ? "border-foreground/30 bg-select text-foreground"
          ...
          <section className="space-y-1" aria-labelledby="settings-library">
            <h2
              id="settings-library"
              className="mb-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground"
            >
            ...
            <div className="flex items-center justify-between gap-6 py-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  Keep perspectives wide; treemap stays off unless you need it later.
                </p>
              </div>
              <Switch
                id="treemap-switch"
